...
export function Dashboard({state,learnedCount,previousSession,setPage,notify}:{state:AppState,learnedCount:number,previousSession?:DailySession,setPage:(p:Page)=>void,notify:(s:string)=>void}) {
