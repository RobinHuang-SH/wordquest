import { ArrowLeft, ArrowRight, BookMarked, Check, CheckCircle2, ChevronRight, LockKeyhole, Sparkles, Volume2 } from 'lucide-react'
import type { AppState } from '../domain/models'
import { getReviewCount } from '../domain/learning'
import { Logo } from '../components/AppShell'

export function Onboarding({step,setStep,state,patch}:{step:number,setStep:(n:number)=>void,state:AppState,patch:(p:Partial<AppState>)=>void}) {
